  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes} {...listeners} className={cn("touch-none", isDragging && "z-10")}>
      <Card
        ...
        className={cn(
          "group relative cursor-grab p-3 transition-colors hover:border-foreground active:cursor-grabbing",
      ...
      >
        <button
          ...
          className="absolute right-2 top-2 border border-transparent p-1 text-muted opacity-0 transition-opacity hover:border-border hover:text-foreground group-hover:opacity-100"
        >
        ...
        <div className="mt-3 flex flex-col gap-1.5 border-t border-border pt-2 font-mono text-[11px] text-muted">
